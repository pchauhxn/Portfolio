  ...
  return (
    <div name='contact' className='w-full h-screen bg-black flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/6e48c4d9-159c-459a-815c-a193183a6cf2" className='flex flex-col max-w-[900px] w-full'>
            ...
            <input className='bg-[#c8c9cd] p-2' type="text" placeholder='Name' name='name' required/>
            <input className='my-4 p-2 bg-[#c8c9cd]' type="email" placeholder='Email' name='email' required />
            <textarea className='bg-[#c8c9cd] p-2' name="message" rows="10" placeholder='Message' required></textarea>
